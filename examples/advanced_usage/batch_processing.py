...
def main():
    ...
    print(f"  - batch_output/custom_configs/")
    
    print(f"\nBatch processing features demonstrated:")
    print(f"  ✓ Parallel processing with ThreadPoolExecutor")
    print(f"  ✓ Multiple input files and output formats")
    print(f"  ✓ Custom serializer configurations")
    print(f"  ✓ Error handling and reporting")
    print(f"  ✓ Results analysis and statistics")
