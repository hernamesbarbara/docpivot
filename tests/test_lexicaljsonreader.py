...
class TestLexicalJsonReader:
    ...
    def test_load_data_valid_lexical_json(self, temp_directory, valid_lexical_json_content):
    ...
    def test_load_data_valid_generic_json(self, temp_directory, valid_lexical_json_content):
