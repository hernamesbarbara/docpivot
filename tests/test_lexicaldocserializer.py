...
class TestLexicalDocSerializer:
    ...
    def test_heading_transformation(self) -> None:
        ...
        headings = [child for child in lexical_data["root"]["children"] 
    ...
    def test_paragraph_transformation(self) -> None:
        ...
        paragraphs = [child for child in lexical_data["root"]["children"] 
    ...
    def test_list_transformation(self) -> None:
        ...
        lists = [child for child in lexical_data["root"]["children"] 
    ...
    def test_table_transformation(self) -> None:
        ...
        tables = [child for child in lexical_data["root"]["children"] 
