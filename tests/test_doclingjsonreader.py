...
class TestDoclingJsonReader:
    ...
    def test_detect_format_generic_json_with_docling_content(self, temp_directory):
        """Test detect_format returns True for .json files with DoclingDocument content."""
        reader = DoclingJsonReader()
    ...
    def test_detect_format_generic_json_without_docling_content(self, temp_directory):
        """Test detect_format returns False for .json files without DoclingDocument content."""
        reader = DoclingJsonReader()
    ...
    def test_load_data_valid_docling_json(self, temp_directory, valid_docling_json_content):
    ...
    def test_load_data_valid_generic_json(self, temp_directory, valid_docling_json_content):
        """Test load_data successfully loads valid .json file with DoclingDocument content."""
        reader = DoclingJsonReader()
    ...
    def test_load_data_pydantic_validation_error(self, temp_directory):
        ...
        # Create a .docling.json file with valid schema but invalid DoclingDocument structure
