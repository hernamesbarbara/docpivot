...
class CustomFormatTestBase(unittest.TestCase, ABC):
    ...
    def _create_simple_document(self) -> DoclingDocument:
        ...
        return DoclingDocument(
            ...
            furniture=[],
            body=NodeItem(children=[
                TextItem(text="This is a simple test document.")
            ])
        )
        ...
        return DoclingDocument(
            ...
            body=NodeItem(children=[
                NodeItem(
                    ...
                    children=[
                        ...
                        NodeItem(
                            ...
                            children=[
                                TextItem(text="Content of subsection 1.1")
                            ]
                        )
                    ]
                ),
                NodeItem(
                    label="Section 2",
                    children=[
                        TextItem(text="Content of section 2")
                    ]
                )
            ])
        )
...
class FormatTestSuite:
    ...
    def _test_reader(self, reader_class: Type[BaseReader], test_files: Optional[List[str]]) -> Dict[str, Any]:
        """Test a reader class.
    ...
    def generate_report(self, results: Dict[str, Any]) -> str:
        ...
        if results["reader_tests"]:
            ...
            if reader_results["file_tests"]:
                successful_files = sum(1 for test in reader_results["file_tests"] if test["success"])
        ...
        if results["serializer_tests"]:
            ...
            if serializer_results["serialization_tests"]:
                successful_tests = sum(1 for test in serializer_results["serialization_tests"] if test["success"])
