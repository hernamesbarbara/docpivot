...
from .io.format_registry import get_format_registry
from .io.plugins import get_plugin_manager, FormatPlugin
...
class ExtensibilityManager:
    ...
    def register_reader(
        self, format_name: str, reader_class: Type[BaseReader], validate: bool = True
    ) -> None:
    ...
    def load_plugin(
        self, plugin: Union[FormatPlugin, Type[FormatPlugin], str, Path]
    ) -> None:
    ...
    def get_serializer(
        self, format_name: str, doc: DoclingDocument, **kwargs: Any
    ...
    def validate_format_pair(
        ...
        Returns:
            Dict[str, Any]: Validation results
        """
        return self._validator.validate_format_pair(
            reader_class, serializer_class, test_file
        )
...
def validate_implementation(
    ...
    if reader_class and serializer_class:
        results["compatibility"] = manager.validate_format_pair(
