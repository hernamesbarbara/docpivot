...
class MemoryProfiler:
    ...
    def profile_memory(self, operation_name: str):
        ...
        monitoring_thread = threading.Thread(
            ...
            args=(process, report, stop_event),
            daemon=True
        )
        monitoring_thread.start()
        
        try:
            logger.info(f"Starting memory profiling for {operation_name} (initial: {initial_memory_mb:.2f} MB)")
            yield report
    ...
    def _monitor_memory(self, process, report: MemoryReport, stop_event: threading.Event):
    ...
    def _basic_memory_profile(self, operation_name: str):
        ...
        report.warnings.append("Basic memory monitoring - install psutil for detailed profiling")
    ...
    def generate_summary(self) -> Dict[str, Any]:
        ...
        efficiencies = [r.memory_efficiency for r in self._reports if r.memory_efficiency > 0]
        ...
        return {
            ...
            "recent_reports": self._reports[-5:] if len(self._reports) >= 5 else self._reports,
            "thresholds": {
        ...
        for op_name, reports in operations.items():
            ...
            analysis[op_name] = {
                ...
                "memory_stats": {
                    ...
                    "memory_correlation": self._calculate_correlation(durations, peaks) if len(peaks) > 1 else 0.0
                },
    ...
    def _generate_memory_recommendations(self, reports: List[MemoryReport]) -> List[str]:
        ...
        if avg_peak > self.warning_threshold_mb:
            recommendations.append("Consider implementing streaming or chunked processing")
        ...
        if warning_rate > 1:
            recommendations.append("Frequent memory warnings - consider lowering memory footprint")
    ...
    def _generate_overall_recommendations(self) -> List[str]:
        ...
        if avg_peak > self.warning_threshold_mb * 0.8:
            recommendations.append("Consider increasing available memory or optimizing algorithms")
